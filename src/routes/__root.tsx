  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="glass-card max-w-md rounded-2xl p-8 text-center">
        <h1 className="font-display text-7xl font-black text-[#7c3aed] text-glow-violet">404</h1>
        <h2 className="mt-4 text-xl font-semibold">Page introuvable</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          Cette route n'existe pas sur ThiakFlow.
        </p>
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-lg bg-[#7c3aed] px-4 py-2 text-sm font-semibold text-white neon-violet"
          >
            Retour à l'accueil
          </Link>
        </div>
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="glass-card max-w-md rounded-2xl p-8 text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="rounded-lg border border-white/10 px-4 py-2 text-sm">
            Accueil
          </a>
        </div>
      </div>
